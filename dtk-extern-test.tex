...
\makeatother
\begin{document}
\title{\dtkFileversion~-- Externe Dokumente aus \LaTeX\ heraus definieren und das Ergebnis einbinden, }
...
\begin{externalDocument}[grfOptions={width=0.5\linewidth},compiler=pdflatex]{Roemer1}
...
\begin{externalDocument}[grfOptions={width=\linewidth},compiler=xelatex,crop]{Senger3}
