%%   $Id: beispiel.tex 42 2014-07-08 17:34:44Z herbert $
%
\documentclass[ngerman]{dtk}
\ifluatex\else
  \usepackage[utf8]{inputenc}
  %\usepackage[latin9]{inputenc}%% Nur, wenn es nicht anders geht
\fi
...
verschachteln:
  \begin{enumerate}
  \item Die maximale Schachtelungstiefe ist~4.
...
\lstinputlisting[style=number,firstline=3,language={[AlLaTeX]{TeX}}]{\jobname.tex}
