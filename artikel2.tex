...
% Definitionen, die in der Gesamt-DTK global wirken müssen.
\begin{dtkGLOBAL}
\DeclareCaptionFont{red}{\small\color{red!60}}
...
\begin{document}
\title{Ein zweiter Artikel zum "`Test"' \DejaVuSans(Zweitautor: Rainer Unsinn)}
...
\begin{figure} \centering
  ...
  \captionsetup{labelfont=red,font=red}
